...
<head>
    ...
    <title>@yield('title') — Secrétariat</title>
...
<div class="app-layout">
    <aside id="sidebar" class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('secretaire.scolarite') }}" class="sidebar-link {{ request()->routeIs('secretaire.scolarite*') ? 'sidebar-link-active' : '' }}">
                <i data-lucide="wallet" class="w-5 h-5"></i> Dossiers scolarité
            </a>
            <a href="{{ route('secretaire.inscription.create') }}" class="sidebar-link {{ request()->routeIs('secretaire.inscription.*') ? 'sidebar-link-active' : '' }}">
                <i data-lucide="user-plus" class="w-5 h-5"></i> Inscrire un élève
            </a>

            <p class="sidebar-section-title">Gestion</p>
            <a href="{{ route('secretaire.requetes') }}" class="sidebar-link {{ request()->routeIs('secretaire.requetes*') ? 'sidebar-link-active' : '' }}">
                <i data-lucide="mail" class="w-5 h-5"></i> Requêtes élèves
            </a>

            <p class="sidebar-section-title">Mon compte</p>
            <a href="{{ route('secretaire.profil') }}" class="sidebar-link {{ request()->routeIs('secretaire.profil*') ? 'sidebar-link-active' : '' }}">
