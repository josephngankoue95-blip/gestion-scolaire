...
<head>
    ...
    <title>@yield('title') — Espace Secrétaire</title>
...
<div class="app-layout">
    <aside id="sidebar" class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('secretaire.scolarite.create') }}" class="sidebar-link {{ request()->routeIs('secretaire.scolarite.create*') ? 'sidebar-link-active' : '' }}">
