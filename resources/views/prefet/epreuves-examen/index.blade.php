...
<div class="card">
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('prefet.epreuves-examen.create') }}" class="btn-primary">+ Insérer une épreuve</a>
    </div>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <div class="flex gap-2">
                            <a href="{{ route('prefet.epreuves-examen.show', $e) }}" class="login-link mr-2">
                                <i data-lucide="eye" class="w-4 h-4"></i>
                            </a>
                            <form method="POST" action="{{ route('prefet.epreuves-examen.destroy', $e) }}"
                                class="inline"
                                data-confirm-delete
